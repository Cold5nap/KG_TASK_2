...
public class Bresenham_Arc implements PixelDrawer {
    private int x0;
    private int y0;
    ...
    public Bresenham_Arc(int x0, int y0, int largeSemiAxis, int smallerSemiAxis, Color smallerAxisColor, Color largeAxisColor) {
        this.x0 = x0;
        this.y0 = y0;
